package com.plasmideditor.rocket.controller;
...
public class FileUploadControllerTest {
    ...
    public void testFiledToUploadSequenceValidationException() throws Exception {
        ...
        ErrorResponse expectedErrorResponse = new ErrorResponse(
                ControllersExceptionHandler.SEQUENCE_VALIDATION_EXCEPTION_MSG + sequenceValidationExceptionMsg);
        String expectedResponseBody = objectMapper.writeValueAsString(expectedErrorResponse);
    ...
    private MockMultipartFile getMultipartFileFromString(String string) throws IOException {
