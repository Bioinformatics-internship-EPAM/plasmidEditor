...
public class FileUploadServiceTest {
    ...
    public void testSuccessfullyUploadDnaFile() throws IOException {
        try (FileInputStream inputStream = getInputStreamFromFile(TEST_DNA_FILE_PATH))
        {
    ...
    public void testSuccessfullyUploadProteinFile() throws IOException {
        try (FileInputStream inputStream = getInputStreamFromFile(TEST_PROTEIN_FILE_PATH)) {
    ...
    @Test
    public void testUploadingIncorrectDnaFileFails() throws IOException {
        try (InputStream inputStream = getInputStreamFromContent("Incorrect DNA file")) {
            assertThrows(
    ...
    @Test
    public void testUploadingIncorrectProteinFileFails() throws IOException {
        try(InputStream inputStream = getInputStreamFromContent("Incorrect Protein file"))
        {
            assertThrows(
                    SequenceValidationException.class,
    ...
    @Test
    public void testUploadingDnaFileWithInvalidCharacterFails() throws IOException {
        try (InputStream inputStream = getInputStreamFromContent(TEST_DNA_FILE_INVALID_CHARACTER_PATH))
        {
            assertThrows(
                    SequenceValidationException.class,
                    ()-> new DNAFileUploadService(mockGenBankService).uploadFile(inputStream)
    ...
    @Test()
    public void testUploadingProteinFileWithInvalidCharacterFails() throws IOException {
        try(InputStream inputStream = getInputStreamFromContent(TEST_PROTEIN_FILE_INVALID_CHARACTER_PATH)) {
            assertThrows(
                    SequenceValidationException.class,
                    () -> new ProteinFileUploadService(mockGenBankService).uploadFile(inputStream)
            );
    ...
    @Test
    public void testUploadProteinFileWithExistingAccessionAndVersion() throws IOException {
        try(FileInputStream inputStream = getInputStreamFromFile(TEST_PROTEIN_FILE_PATH)) {
            assertThrows(
